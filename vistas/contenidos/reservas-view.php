            ...
            <div class="menu">
                ...
                <nav id="nav">
                    ...
                    <ul>
                        ...
                        <li><a href="reservas" id="selected">Reservas</a></li>
                    </ul>
                </nav>
            </div>
        </div>
    ...
    <main>
        <div class="container__cover">
            ...
            <div class="cover">
                ...
                <h1 style="background-color:#CA9F2D;">RESERVA DE MESAS EN NUESTRO LOCAL</h1>
                    <img src="/mesas_reservas/vistas/images/bebidas.png" alt="chef">
                    <p >
                        Completa el registro y conviertete en nuestro cliente y podras hacer reserva mesas en nuestro restaurante, ademas
                         nos ofrece posada al abrigo de su gran chimenea. 
                         El comedor del platita está pensado para albergar pequeñas celebraciones o comidas de empresa, 
                         con una capacidad de hasta ochenta personas.</p>
                    

                </div>

                <div class="svg">
                    <img src="/mesas_reservas/vistas/images/mesa.png" alt="">
                </div>
            </div>
        </div>
    </main>
