<section class="full-box nav-lateral">
			...
			<div class="full-box nav-lateral-content">
				<figure class="full-box nav-lateral-avatar">
					...
					BIENVENIDO<br><?php echo $_SESSION['nombre_SDR']." ".$_SESSION['apellido_SDR']; ?><br><?php echo $_SESSION['rut_SDR'] ?><br>TRABAJADOR
					</figcaption>
				</figure>
				...
				<nav class="full-box nav-lateral-menu">
					<ul>
						<li>
							<a href="<?php echo SERVERURL;?>home-trabajador"><i class="fab fa-dashcube fa-fw"></i> &nbsp; Dashboard </a>
						</li>
