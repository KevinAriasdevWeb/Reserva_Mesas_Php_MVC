...
/*------ para saber si tenemos peticiones ajax o no.   ------*/
...
class mainModel
{
    ...
    /*------  Funcion para validar datos de formulario -----*/
    ...
    /*------  Funcion para paginar de tablas -----*/

    protected static function paginador_tablas($pagina, $Npaginas, $url, $botones)
    {
        $tabla = '<nav aria-label="Page navigation example">
<ul class="pagination justify-content-center">';
        // para ir hacia atras y desabilitar boton cuando este en pagina 1
        if ($pagina == 1) {
    ...
    ';
        ...
        // para ir hacia adelante y desabilitar boton cuando este en la ultima pagina
        if ($pagina == $Npaginas) {
